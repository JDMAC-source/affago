...
urlpatterns = [
	...
	path('storefront/<author>/<storefront_title>/index/', views.storefront_index, name='storefront_index'),
	path('storefront/<author>/<storefront_title>/about/', views.storefront_about, name='storefront_about'),
	path('storefront/<author>/<storefront_title>/story/', views.storefront_story, name='storefront_story'),
	...
	path('storefront/<author>/<storefront_title>/product_list/', views.storefront_product_list, name='storefront_product_list'),
	path('storefront/<author>/<storefront_title>/past_purchases/', views.storefront_past_purchases, name='storefront_past_purchases'),
	path('delete_storefront/<author>/<storefront_id>/', views.delete_own_storefront, name='delete_own_storefront'),
    ...
    path('api/checkout-session/<price_id>/<storefront_id>/', views.create_checkout_session, name='api_checkout_session'),
